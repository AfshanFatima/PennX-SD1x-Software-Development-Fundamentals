...
public class WhackAMole {
	...
	/**
	 * Specifies total number of whacks allowed, and the grid dimension. Initializes
	 * the moleGrid with the * character.
	 * 
	...
	/**
	 * Given a location, place a mole at that location. Update number of moles left.
