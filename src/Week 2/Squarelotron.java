...
public class Squarelotron {
	...
	int size;
	/*
	 * Fills the 2-dimensional array with the numbers 1 to n squared, in order. Sets
	...
	public boolean isOnRing(int i, int j, int ring) {
		boolean isOn = (i == ring - 1 || j == ring - 1 || i == size - ring || j == size - ring); // a square has at
																									// least 1 side on
																									// the ring
		boolean isOut = (i <= ring - 2 || i >= size + 1 - ring || j <= ring - 2 || j >= size + 1 - ring); // the square
																											// is
																											// outside
																											// the ring
	...
	/*
	 * performs the Upside-Down Flip of the squarelotron returns the new
	 * squarelotron. The original squarelotron should not be modified.
	 */
	...
	/*
	 * performs the Main Diagonal Flip of the squarelotron returns the new
	 * squarelotron. The original squarelotron should not be modified.
	 */
	 ...
	 * squarelotron should be rotated 90° clockwise. Any integer, including zero and
	 * negative integers, is allowable as the argument. A value of -1 indicates a
	 * 90° counterclockwise rotation. This method modifies the internal
	 * representation of the squarelotron; it does not create a new squarelotron.
	 */
